...
export default function AuthLayout({
  ...
  return (
    <main className="w-full min-h-dvh grid grid-cols-1 md:grid-cols-2 py-14 relative">
      {/* Video Background */}
      ...
      <div className="absolute z-6 top-0 w-full h-full inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent" />
